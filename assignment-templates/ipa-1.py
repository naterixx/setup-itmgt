...
def savings(gross_pay, tax_rate, expenses):
    ...
    remaining_amount = after_tax_pay - expenses
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    material_units = input('Please input the unit of measurement for the material: ')
...
def interest(principal, rate, periods):
    ...
    gain = round(principal*rate*periods)
    final_balance = gain+principal
